...
class NeuralTransformer(nn.Module):
    def __init__(self, EEG_size=1600, patch_size=200, in_chans=1, out_chans=8, num_classes=1000, embed_dim=200, depth=12,
                 ...
                 use_mean_pooling=True, use_attention_pooling=False, init_scale=0.001, **kwargs):
        super().__init__()
        ...
        if self.use_attention_pooling:
            ...
            trunc_normal_(self.attention_pool.weight, std=.02)
            nn.init.constant_(self.attention_pool.bias, 0)
