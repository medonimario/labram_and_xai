...
def get_args():
    ...
    parser.add_argument('--use_attention_pooling', action='store_true', help='Use attention pooling instead of mean/cls pooling')
    parser.set_defaults(use_attention_pooling=False)
...
def get_models(args):
    model = create_model(
        ...
        use_attention_pooling=getattr(args, 'use_attention_pooling', False),
