...
if __name__ == "__main__":
    ...
    # Split by triad ID for 10-fold CV
    ...
    # Using 'processed_group_cv' to distinguish from the standard train/val/test run
    base_dump_dir = os.path.join(final_root, "processed_group_cv") 
    ...
    def prepare_params(file_list, dump_folder):
        ...
        for f in file_list:
            ...
            # The label is determined inside the process_epoch_file function
