...
if __name__ == "__main__":
    ...
    root = os.path.join(raw_dataset_path, "tuh_eeg_abnormal/v3.0.1/edf")
    ...
    final_root = os.getenv("PROCESSED_DATASET_PATH") + "/tuh_eeg_abnormal"
    
    # create the train, val, test sample folder
    if not os.path.exists(os.path.join(final_root, "processed")):
        os.makedirs(os.path.join(final_root, "processed"))

    if not os.path.exists(os.path.join(final_root, "processed", "train")):
        os.makedirs(os.path.join(final_root, "processed", "train"))
    train_dump_folder = os.path.join(final_root, "processed", "train")

    if not os.path.exists(os.path.join(final_root, "processed", "val")):
        os.makedirs(os.path.join(final_root, "processed", "val"))
    val_dump_folder = os.path.join(final_root, "processed", "val")

    if not os.path.exists(os.path.join(final_root, "processed", "test")):
        os.makedirs(os.path.join(final_root, "processed", "test"))
